 ...
 *}
<p>{l s='Your order on' mod='secupay'}
    <span
            class="bold"
    >{$shop_name|escape:'htmlall':'UTF-8'}</span> {l s='is complete.' mod='secupay'}
    <br /><br />
    {l s='Thank you for your Order.' mod='secupay'}
    <br /><br /><span class="bold">{l s='Your order will be sent very soon.' mod='secupay'}</span>
    <br /><br />{l s='For any questions or for further information, please contact our' mod='secupay'}
    <a
            href="{$link->getPageLink('contact-form.php', true)|escape:'htmlall':'UTF-8'}"
    >{l s='customer support' mod='secupay'}</a>.
</p>
